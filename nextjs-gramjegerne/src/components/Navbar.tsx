    ...
    <nav className="nav pb-8 relative">
      <div className="flex flex-wrap items-center justify-between mx-auto">
        ...
        <button
          ...
          className="md:hidden menu-item p-2"
        >
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto menu-collapse">
            ...
            {isLoading ? (
              ...
              <button
                onClick={() => signOut()}
                className="menu-item flex items-center w-full md:w-auto justify-center"
              >
              ...
              <button
                ...
                className="menu-item flex items-center gap-2 px-4 py-2 rounded-md w-full md:w-auto justify-center"
              >
                <svg
                  className="w-5 h-5"
                  viewBox="0 0 24 24"
