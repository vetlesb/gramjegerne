...
const nb: Translations = {
  ...
  trips: {
    ...
    connectAList: 'Koble en liste',
    noMapsYet: 'Ingen kart tilkoblet ennå.',
    noListsYet: 'Ingen lister tilkoblet ennå.',
    noListsToConnect: 'Ingen lister tilgjengelig. Opprett en liste først.',
    listConnected: '1 liste tilkoblet',
    listsConnected: '{count} lister tilkoblet',
    mapConnected: '1 kart tilkoblet',
    mapsConnected: '{count} kart tilkoblet',
    mainMap: 'Hovedkart',
  ...
  misc: {
    ...
    searchLists: 'Søk etter liste',
    searchMaps: 'Søk etter kart',
