          ...
          >
            {filteredItems.map((item: Item) => (
              <li
                ...
                className={
                  viewMode === 'list'
                    ? 'product flex items-center gap-4 py-2 rounded-md'
                    : 'product flex flex-col gap-2 p-3 rounded-md bg-dimmed'
                }
              >
                {viewMode === 'list' ? (
                  ...
                  <div className="flex flex-col image-minus gap-y-4">
                    <div className="relative">
                      ...
                      {item.image?.asset ? (
                        ...
                        <div className="h-full w-full aspect-square flex items-center placeholder_image cursor-pointer">
                          <svg
                            width="16"
                            height="16"
                            viewBox="0 0 29 24"
